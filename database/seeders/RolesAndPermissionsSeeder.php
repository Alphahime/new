...

{
    ...
    public function run(): void
    {
        ...
        foreach (array_merge($adminPermissions, $associationPermissions) as $permission) {
        ...
        $roleAssociation->syncPermissions($associationPermissions);

        // Crée un rôle pour user s'il n'existe pas
